                                    ...
                                    else
                                    {
                                        ...
                                        if (isOK)
                                        {
                                            ...
                                            if (isNumberic(toolnum, out _toolnum))
                                            {
                                                ...
                                                if (dt[i, 8].ToString() != "" && dt[i, 8] != null)
                                                {
                                                    if (dt[i, 8].ToString().Contains(':'))
                                                    {
                                                        var timeInfo = dt[i, 8].ToString().Split(':');
                                                    ...
                                                    else if (dt[i, 8].ToString() == "---")
                                                    {
                                                        ProcessTime += 5;
                                                    }
                                                    else
                                                    {
                                                        ProcessTime += (Convert.ToDouble(dt[i, 8].ToString()) * 1440);
                                                    }
                                                }
                                                if (!ToolNum.Contains(Convert.ToInt32(dt[i, 2].ToString())))
                                                {
                                                    ...
                                                    string tooll = dt[i, 7].ToString();
                                                    double _tooll = 0;
                                                    if (isNumberic(tooll, out _tooll))
                                                    {
                                                        tool.ToolLength = Convert.ToDouble(dt[i, 7].ToString());
                                                    }
                                                    string ToolD = dt[i, 5].ToString();
                                                    double _ToolD = 0;
                                                    if (isNumberic(ToolD, out _ToolD))
                                                    {
                                                        tool.BladeLenth = Convert.ToDouble(dt[i, 5].ToString());
                                                    }

                                                    string Toole = dt[i, 6].ToString();
                                                    if (Toole == "")
                                                    {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        if (isNumberic(ToolD, out _ToolD))
                                                        {
                                                            tool.EffectiveLength = Convert.ToDouble(dt[i, 6].ToString());
                                                        }
                                                    }
