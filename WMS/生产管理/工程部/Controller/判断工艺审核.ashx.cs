...
namespace WebApplication2.生产管理.工程部.Controller
{
    ...
    /// 判断工艺审核 的摘要说明
    /// </summary>
    public class 判断工艺审核 : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var processRow = entities.JDJS_WMS_Order_Process_Info_Table.Where(r => r.OrderID == orderId&r.sign!=1);
            if (processRow.Count() > 0)
            {
                context.Response.Write("您有工序未审核通过");
            }
            else
            {
